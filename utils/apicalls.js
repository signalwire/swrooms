...
async function get_token_for_video(roomDetails, space, dryRun = false) {
  if (dryRun) return ROOMTOKEN;
  console.log('heryu');
  console.log(roomDetails, space);

  try {
    let token = await Axios.post(apiurl + '/public/video_token', {
